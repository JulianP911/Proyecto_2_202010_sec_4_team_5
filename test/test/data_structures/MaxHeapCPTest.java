...
public class MaxHeapCPTest 
{
	 ...
	 */
	private MaxHeapCP<Integer> colaPrioridad1;
	
	/**
	 * Cola de prioridad de tipo String
	 */
	private MaxHeapCP<String> colaPrioridad2;
	
	/**
	 * Cola de prioridad de tipo double
	 */
	private MaxHeapCP<Double> colaPrioridad3;
	...
	{
		colaPrioridad1 = new MaxHeapCP<Integer>();
	...
	{
		colaPrioridad2 = new MaxHeapCP<String>();
	...
	{
		colaPrioridad3 = new MaxHeapCP<Double>();
	}
	...
	void testIterator() 
	{
		MaxHeapCP<String> colaPrioridad4 = new MaxHeapCP<String>();
