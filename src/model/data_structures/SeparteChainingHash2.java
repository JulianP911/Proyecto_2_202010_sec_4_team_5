...
public class SeparteChainingHash2 <K extends Comparable<K>, V >
{
	/**
	...
	public SeparteChainingHash2(int m) 
	{
		this.m = m;
	...
	private void resize(int chains)
	{
		...
		SeparteChainingHash2<K, V> temp = new SeparteChainingHash2<K, V>(capacidad);
		for (int i = 0; i < m; i++) 
		{
			for (K key : st[i].keys()) 
